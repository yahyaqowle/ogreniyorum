...
#
# ##Info
# ##if i want to split every word in a text
# ##like converting to csv we use
# #f = open("convert.txt", "r", encoding='utf-8')
# #a = f.read().split()
# #print(a)
#
# ##the error of encodings we can fix
# #3#encoding='utf-8' # adding it after 'r' or 'w'
# ##example here it shows
# #  f = open("convert.txt", "r", encoding='utf-8')
#
# ##if i want to get first word of each line in str we can fix it
# ##with open('convert.txt', 'r', encoding='utf-8') as f:
# #   for line in f:
# #        print(line.split(' ')[0])
#
# ## if we want to save the output of a code to txt file
